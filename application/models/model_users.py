...
def insert_users(username, password, privilege, status, name, email, direccion, telefono, maestria, other_data, user_hash, change_pwd):
    try:
        """
        ...
        values ($username, $password, $privilege, $status, $name, $email, $direccion, $telefono, $maestria, $other_data, $user_hash, $change_pwd);
        """
        db.insert('users',
            username=username,
            password=password,
...
def edit_users(username, password, privilege, status, name, email, direccion, telefono, maestria, other_data, user_hash, change_pwd):
    try:
        """
